  ...
  return (
    <div className="">
      <>
        ...
        {/*<!-- Header --> */}
        <header className="border-b-1 z-20 w-full border-b border-slate-200 bg-yellow-100 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
          <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
            ...
            >
              ...
              <a
                ...
                aria-current="page"
                className="flex items-center gap-2 whitespace-nowrap py-3 text-2xl font-semibold focus:outline-none lg:flex-1"
