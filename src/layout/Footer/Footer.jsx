    ...
    <div>
      <>
        ...
        <footer className="w-full text-black">
          {/*    <!-- Main footer --> */}
          <div className="pt-16 pb-12 text-sm border-t border-emerald-600 bg-yellow-100">
            <div className="container px-6 mx-auto">
              <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
                ...
                >
                  <h3
                    className="mb-6 text-base font-medium text-yellow-900"
                    id="footer-header"
                  >
                    Product
                  </h3>
          ...
          {/*    <!-- Subfooter --> */}
          <div className="py-4 text-sm border-t border-emerald-700 bg-yellow-300">
            <div className="container px-6 mx-auto">
              <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
                <div className="col-span-2 md:col-span-4 lg:col-span-6">
                  Copyright 2023 Foreign Language
                </div>
                <nav
